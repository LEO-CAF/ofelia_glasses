...
public class PlayerMovement : MonoBehaviour {
    ...
    public static PlayerMovement Instance { get; set; } // my code
    ...
    private void Update() {
        ...
        if (cameraCanMove && !GameUI.Instance.IsPause()) // MY CODE
        {
    ...
    void FixedUpdate() {
        ...
        if (playerCanMove) {
            ...
            Vector2 inputVector = InputManager.Instance.Movement();
